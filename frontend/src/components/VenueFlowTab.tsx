...
import '../styles/VenueFlowTab.css';

interface VenueFlowTabProps {
  venueId: string;
  timeRange: string;
  k: number;
  loading: boolean;
...
export const VenueFlowTab = ({
  ...
  return (
    <Box className="venue-flow-container">
      <Typography variant="h6" className="venue-flow-title">
        Venue Flow Analysis
      </Typography>
